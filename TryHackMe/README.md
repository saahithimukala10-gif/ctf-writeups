...
[TryHackMe](https://tryhackme.com) pairs guided learning paths with hands-on vulnerable machines, so I use it to build foundational security knowledge and practical exploitation experience side by side.
...
| SOC Level 1 / learning rooms | 7 completed — in progress on Section 2: SOC Team Internals. See [`SOC Level 1`](Learning%20Paths/SOC%20Level%201/README.md) |
